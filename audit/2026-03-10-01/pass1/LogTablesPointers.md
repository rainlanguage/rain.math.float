...
**File:** Auto-generated constants file, no contract/library declaration, no
functions, no assembly, no imports.
...
Data integrity spot-checked against `LibLogTable.logTableDec()` and
