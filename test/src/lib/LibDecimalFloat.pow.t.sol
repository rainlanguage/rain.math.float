...
contract LibDecimalFloatPowTest is LogTest {
    ...
    function testPows() external {
        ...
        // checkPow(9998, 0, 12182, 0, 6050, 48723);
        // checkPow(99998, 0, 12182, 0, 1000, 60907);
        ...
        checkPow(99999, 0, 12182, 0, 8.853071703048649170130397094169464632911643045383977634639832229931e66, 60843);
